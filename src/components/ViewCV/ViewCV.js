...
const ViewCV = props => {
    ...
    return (
        <div className="jumbotron shadow">
            ...
            <hr />
            <h1 className='text-secondary display-3'><span className='text-danger'>#</span> Skills:</h1>
            {
            ...
            <hr />
            <h1 className='text-secondary display-3'><span className='text-danger'>#</span> Experience:</h1>
            ...
            <hr />
            <h1 className='text-secondary display-3'><span className='text-danger'>#</span> Projects:</h1>
            {
